...
SRCS = main.c commands.c commands2.c commands3.c commands4.c check.c check2.c \
	pre_parsing.c pre_parsing2.c replace.c replace2.c parsing.c \
	utils.c utils2.c utils3.c free.c
OBJS_EXEC = ${SRCS:.c=.o}
EXEC = minishell
